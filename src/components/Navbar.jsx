    ...
    <>
      ...
      <nav className="fixed w-full top-0 z-50 transition-all duration-300 bg-gray-900 border-b border-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div
            className={`fixed inset-y-0 right-0 w-full sm:max-w-sm bg-gray-900 shadow-2xl transition-transform duration-300 ease-in-out md:hidden ${
                ...
                {navLinks.map(link => (
                  <div key={link.name}>
                    ...
                    >
                      ...
                      {link.dropdown && (
                        <ChevronRight size={20} className={`transform transition-transform duration-200 ${mobileActiveDropdown === link.name ? 'rotate-90' : ''}`} />
                      )}
                    </button>
